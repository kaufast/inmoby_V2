...
export const metadata = {
  title: "Property Single V1 || Inmobi - Real Estate NextJS Template",
};
        ...
        <div className="container">
          ...
          <div className="row wrap">
            <div className="col-lg-8">
              ...
              <div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
                <h4 className="title fz17 mb30">360° Tour Virtual</h4>
                <div className="row">
                  <VirtualTour360 />
                </div>
              </div>
              ...
              <div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
              <h4 className="title fz17 mb30">Lugares de Interés Cercanos</h4>
              <div className="row">
                  <PropertyNearby />
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    <h4 className="fw400 mb20">
                      Calle de la Ribera Barcelona  08003 España
                    </h4>
                    <WalkScore />
                  </div>
                </div>
              ...
              <div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
                <h4 className="title fz17 mb30">Calculadora de Hipoteca</h4>
                <div className="row">
                  <MortgageCalculator />
                </div>
              </div>
